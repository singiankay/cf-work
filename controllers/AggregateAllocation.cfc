				...
				SELECT a.id_record AS model_id, a.mSap AS model_no, 
				 ...
				 INNER JOIN (
				  	  SELECT ba.mrModel, bb.process_rev 
				  		...
				  		INNER JOIN (
				  		 	 SELECT bba.mrModel, MAX(bba.mrRevision) AS process_rev
				  		 	   FROM tbl_model_revision bba 
				  		 	  INNER JOIN ( 
					  	 	       ...
					  	 	       GROUP BY mrModel
				  		 	          ...
				  		 	          ON bbb.mrModel = bba.mrModel 
				  		 	         AND bbb.bom_rev > bba.mrRevision 
				  		 	  WHERE bba.mrType = 0 
				  		 	    AND bba.mrActive = 1 
				  		 	    AND bba.mrApproved = 2 
				  		 	  GROUP BY bba.mrModel
				  		   ) bb 
