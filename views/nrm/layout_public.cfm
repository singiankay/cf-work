...
<cfoutput>
	...
	<head>
		...
		<title>#title#</title>
		<!--- <link rel="icon" href="../../images/nrm.ico" type="image/x-icon"> --->
		<link rel="icon" href="#getImageAssetPath("nrm.ico")#" type="image/x-icon">
	...
	<body class="has-navbar-fixed-top">
		<div id="app">
			#includePartial("/nrm/search/nav")#
			#includePartial("/nrm/search/alert")#
			#includeContent()#
			#includePartial("/nrm/search/footer")#
		</div>
		#includePartial("js")#
