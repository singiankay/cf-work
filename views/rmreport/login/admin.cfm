			...
			<div class="hero-body">
				<div class="container has-text-centered">
					<div class="column is-4 is-offset-4">
						...
						<h3 class="title has-text-grey">RM Report</h3>
						...
						<div class="box">
							...
							<cfif structKeyExists(URL, "redirectTo")>
								<cfif structKeyExists(URL, "redirectKey")>
									#startFormTag(route="rmreportAuthenticateAdmin", params="redirectTo=#URL.redirectTo#&redirectKey=#URL.redirectKey#")#
								<cfelse>
									#startFormTag(route="rmreportAuthenticateAdmin", params="redirectTo=#URL.redirectTo#")#
								</cfif>
							<cfelse>
								#startFormTag(route="rmreportAuthenticateAdmin")#
							</cfif>
								...
								<br>
								#buttonTag(content="Login", class="button is-block is-info is-large is-fullwidth", argumentCollection={ ":disabled" = "name == ''" })#
							#endFormTag()#
						</div>
