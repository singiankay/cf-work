	...
	<div class="container-fluid">
		<div class="columns">
			<div class="column is-10">
				<h3 id="details" class="title">JO <strong class="has-text-primary" v-cloak>{{ jo.jo_number }}</strong></h3>
				<h3 class="subtitle">
				...
				<div class="box" v-cloak>
					<div class="content">
						...
						<div class="field is-grouped is-grouped-right">
							<div class="control">
							  	<button type="button" class="button is-primary" :class="{ 'is-disabled' : materials.length == 0, 'is-disabled is-loading' : isSubmit == true }" :disabled="materials.length == 0 || isSubmit == true" @click="newRevision">Create Revision</button>
