		...
		<div class="container-fluid">
			<div class="columns">
				<div class="column is-10">
					<h3 id="details" class="title">Create New JO</h3>
					<div class="box">
						<div class="columns">
							<div class="column is-one-third">
								...
								<div class="field">
									...
									<div class="control">
										<input type="radio" v-model="jo.designation" value="Order" class="is-checkradio" id="designation_order" name="designation" tabindex="2" v-cloak>
										<label for="designation_order">Order</label>
										<input type="radio" v-model="jo.designation" class="is-checkradio" value="Stock" id="designation_stock"  name="designation" tabindex="2" v-cloak>
								...
								<div class="field">
									...
									<div class="control">
										<input :class="{ 'input' : true }" type="text" tabindex="3" v-model="jo.jo_reference" v-cloak>
									</div>
								</div>
							</div>
							<div class="column is-one-third">
								<div class="field">
									...
									<div class="control">
										<input type="text" class="input" tabindex="4" v-model="jo.fourm_change" v-cloak>
									</div>
								</div>
								<div class="field">
									<label class="label">6M Change</label>
									<div class="control">
										<input type="text" class="input" tabindex="4" v-model="jo.sixm_change" v-cloak>
									</div>
								</div>
								<div class="field">
									<label class="label">SA Number</label>
									<div class="control">
										<input type="text" class="input" tabindex="6" v-model="jo.sa_no" v-cloak>
									</div>
								</div>
							</div>
							<div class="column is-one-third">
								<div class="field">
									...
									<div class="field">
										<input :class="{ 'is-checkradio' : true, 'is-danger' : errors.has('jo.jo_type') }" v-model="jo.type" data-vv-as="JO type" v-validate="'required'" data-vv-scope="jo" id="jo_type_mass_production" value="Mass Production" type="checkbox" name="jo_type" checked="checked" tabindex="7" v-cloak>
										<label for="jo_type_mass_production">Mass Production</label>
									</div>
									<div class="field">
										<input class="is-checkradio" v-model="jo.type" id="jo_type_regrade" value="Regrade" type="checkbox" name="jo_type" tabindex="7" v-cloak>
										<label for="jo_type_regrade">Regrade</label>
									</div>
									<div class="field">
										<input class="is-checkradio" v-model="jo.type" id="jo_type_retest" value="Retest" type="checkbox" name="jo_type" tabindex="7" v-cloak>
										<label for="jo_type_retest">Retest</label>
									</div>
									<div class="field">
										<input class="is-checkradio" v-model="jo.type" id="jo_type_rework" value="Rework" type="checkbox" name="jo_type" tabindex="7" v-cloak>
										<label for="jo_type_rework">Rework</label>
									</div>
									<div class="field">
										<input class="is-checkradio" v-model="jo.type" id="jo_type_reinspection" value="Reinspection" type="checkbox" name="jo_type" tabindex="7" v-cloak>
						...
						<div class="columns">
							<div class="column is-half">
								<div class="field">
									...
									<div class="control">
										<multiselect 
											v-model="jo.model" :options="modelOptions" label="text" track-by="id" 
											...
											v-validate="'required'" :class="{ 'is-danger': errors.first('jo.model')  }" data-vv-validate-on="blur" data-vv-name="model" data-vv-value-path="jo.model" data-vv-scope="jo"
								...
								<div class="columns">
									<div class="column is-half">
										<div class="field">
											...
											<div class="control">
												<input :class="{ 'input' : true, 'is-danger' : errors.has('jo.qty_to_produce') }" type="number" v-model="jo.qty_to_produce" v-validate="'required'" data-vv-scope="jo" data-vv-as="Qty To Produce" name="qty_to_produce" placeholder="Enter Integer" tabindex="9" v-cloak>
												<p class="help is-danger" v-show="errors.has('jo.qty_to_produce')" v-cloak>{{ errors.first('jo.qty_to_produce') }}</p>
											</div>
										</div>
										<div class="field">
											<label class="label">Lot Code</label>
											<div class="control">
												<input :class="{ 'input' : true }" type="text" v-model="jo.lot_code" placeholder="Enter LotCode" tabindex="11" v-cloak>
											</div>
										</div>
									</div>
									<div class="column is-half">
										<div class="field">
											...
											<div class="control">
												<input :class="{ 'input' : true, 'is-danger' : errors.has('jo.total_shipment_qty') }" type="number" name="total_shipment_qty" v-model="jo.total_shipment_qty" data-vv-scope="jo" data-vv-as="Total Shipment Quantity" v-validate="'required'" placeholder="Enter Integer" tabindex="10" v-cloak>
												<p class="help is-danger" v-show="errors.has('jo.total_shipment_qty')" v-cloak>{{ errors.first('jo.total_shipment_qty') }}</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="column is-half">
								<div class="field">
									...
									<div class="control">
										<vuejs-datepicker name="production_month" :input-class="{ 'input' : true, 'is-danger': errors.has('jo.production_month') }" v-model="jo.production_month" v-validate="'required|date_format'" data-vv-as="Production Month" data-vv-scope="jo" minimum-view="month" maximum-view="month" :format="'MMMM yyyy'" v-cloak></vuejs-datepicker>
										<p class="help is-danger" v-show="errors.has('jo.production_month')" v-cloak>{{ errors.first('jo.production_month') }}</p>
									</div>
								</div>
								<div class="columns">
									<div class="column is-half">
										<div class="field">
											...
											<div class="control">
												<vuejs-datepicker name="requested_start_date" :input-class="{ 'input' : true, 'is-danger': errors.has('jo.requested_start_date') }" v-model="jo.requested_start_date" format="MMMM dd yyyy" v-validate="'required|date_format'" data-vv-as="Requested Start Date" data-vv-scope="jo" v-cloak></vuejs-datepicker>
												<p class="help is-danger" v-show="errors.has('jo.requested_start_date')" v-cloak>{{ errors.first('jo.requested_start_date') }}</p>
											</div>
										</div>
									</div>
									<div class="column is-half">
										<div class="field">
											...
											<div class="control">
												<vuejs-datepicker name="requested_end_date" :input-class="{ 'input' : true, 'is-danger': errors.has('jo.requested_end_date') }" v-model="jo.requested_end_date" v-model="jo.requested_end_date" format="MMMM dd yyyy" v-validate="'required|date_format'" data-vv-as="Requested End Date" data-vv-scope="jo" v-cloak></vuejs-datepicker>
												<p class="help is-danger" v-show="errors.has('jo.requested_end_date')" v-cloak>{{ errors.first('jo.requested_end_date') }}</p>
											</div>
										</div>
									</div>
								</div>								
						...
						<div class="columns">
							<div class="column is-one-third">
								<div class="field">
									...
									<div class="control">
										<input class="input" type="text" v-model="jo.batch_no" tabindex="13">
									</div>
								</div>
								<label class="label">Inclusion</label>
								<div class="field">
									<input class="is-checkradio" id="include_chemicals" type="checkbox" name="include_chemicals" tabindex="14" v-model="jo.include_chemicals">
							...
							<div class="column is-two-thirds">
								<div class="field">
									...
									<div class="control">
										<textarea class="textarea" v-model="jo.remarks" placeholder="Enter Anything here." tabindex="15" v-cloak></textarea>
									</div>
								</div>
							</div>
						</div>
						<div class="columns">
							...
							<div class="column is-one-third">
								...
								<div class="field is-grouped">
									<div class="control">
									  <button class="button is-primary" :class="{'is-disabled' : canComputeMaterial != true }" :disabled="canComputeMaterial != true" @click="calculateBom" tabindex="16">{{ calculateText }}</button>
									</div>
								</div>
							</div>
						</div>
											...
											<table class="table is-bordered is-narrow is-hoverable is-fullwidth">
												<tr>
													<td style="border-top: none; border-bottom: none; min-width: 30px; max-width: 30px;">
														<span class="icon tooltip is-tooltip-right" :class="materialClass(m.classification, classifications)" :data-tooltip="m.classification | materialClassification(classifications)">
					...
					<div class="box" v-cloak>
						<div class="content">
							...
							<div class="field is-grouped is-grouped-right">
								<div class="control">
								  <button type="button" class="button is-primary" :class="{'is-disabled' : canSave != true, 'is-disabled is-loading' : isSubmit == true }" :disabled="canSave != true || isSubmit == true" @click="createJo">Save JO</button>
								  #startFormTag(method="get", route="joEncodeRedirect", ref="redirect")#
