			...
			<div class="hero-body">
				<div class="container has-text-centered">
					<div class="column is-4 is-offset-4">
						...
						<h3 class="title has-text-grey">Warehouse Management System</h3>
						...
						<div class="box">
							...
							<cfif structKeyExists(URL, "redirectTo")>
								<cfif structKeyExists(URL, "redirectKey")>
									#startFormTag(route="wmsauthenticate", params="redirectTo=#URL.redirectTo#&redirectKey=#URL.redirectKey#")#
								<cfelse>
									#startFormTag(route="wmsauthenticate", params="redirectTo=#URL.redirectTo#")#
								</cfif>
							<cfelse>
								#startFormTag(route="wmsauthenticate")#
							</cfif>
