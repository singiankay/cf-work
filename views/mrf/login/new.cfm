			...
			<div class="hero-body">
				<div class="container has-text-centered">
					<div class="column is-4 is-offset-4">
						...
						<h3 class="title has-text-grey">Material Requisition</h3>
						...
						<div class="box">
							...
							<cfif structKeyExists(URL, "redirectTo")>
								<cfif structKeyExists(URL, "redirectKey")>
									#startFormTag(route="mrfauthenticate", params="redirectTo=#URL.redirectTo#&redirectKey=#URL.redirectKey#")#
								<cfelse>
									#startFormTag(route="mrfauthenticate", params="redirectTo=#URL.redirectTo#")#
								</cfif>
							<cfelse>
								#startFormTag(route="mrfauthenticate")#
							</cfif>
								...
								<div class="field">
									<div class="control is-expanded">
										<div class="select is-fullwidth">
											#selectTag(name="division", options=divisions, valueField="", textField="", class="input is-large", argumentCollection={ 'v-model':'selected_division' }, label=false)#
										</div>
									</div>
								</div>
								<br>
